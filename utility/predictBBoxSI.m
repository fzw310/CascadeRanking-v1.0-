function objPotentialBoxesSI = predictBBoxSI( im3u, base, W, NSS, numDetPerSz, T, filter1W, szActive, ColorboxesRecLayerIdxHist)
...
for i = NUM_sz:-1:1
    ...
    if height/W >= 8 && width/W >= 8
        ColorboxesRecLayerRate =  ColorboxesRecLayerIdxHist(i)*64/((m+7)*(n+7));
    else
