function objPotentialBoxes = getObjBndBoxes( im3u, BING, ColorboxesRecLayerIdxHist)

BoxesSI = predictBBoxSI(im3u, BING.base, BING.W, BING.NSS, BING.numDetPerSz, BING.T, BING.filter1W, BING.sizeActive, ColorboxesRecLayerIdxHist);
